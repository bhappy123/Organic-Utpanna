...
<main class="sign-up-main p-5 bg-success text-white" style="min-height: 100vh;">
    ...
    <p class="bolder p-1 text-center">Current Order Status: <span><?php echo $_POST['orderStatus'] ?></span></p>
        ...
        <div class="form-group">
            <label for="dispatched_msg">Dispatched Message</label>
            <input type="text" class="p-2 w-100 mb-4" id="dispatched_msg" name="dispatched_msg" value="<?php echo $_POST['dispatched_msg'] === "" ? "" : $_POST['dispatched_msg']  ?>">
        </div>
        <div class="form-group">
            <label for="shipped_msg">Shippment Message</label>
            <input type="text" class="p-2 w-100 mb-4" id="shipped_msg"name="shipped_msg" value="<?php echo $_POST['shipped_msg'] === "" ? "" : $_POST['shipped_msg'] ?>">
        </div>
        <div class="form-group">
