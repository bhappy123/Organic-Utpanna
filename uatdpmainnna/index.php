	  	...
	  	<div class="side-bar">
	  		<div class="side-bar-links">
	  			...
	  			<ul class="navbar-nav">
	  				...
	  				<li class="nav-item">
	  					<a href="./controller/logout.php" class="nav-links d-block"><i class="fa fa-power-off"></i> Log Out</a>
	  				</li>
	  			</ul>
	  		</div>
	  		<div class="side-bar-icons">
	  			<div class="icons d-flex flex-column align-items-center">
					...
					<a href="./controller/logout.php" class="set-width text-center display-inline-block my-1"><i class="fa fa-power-off"></i></a>
	  			</div>
	  		</div>
	  	</div>
  		...
  		<div class="table-responsive bg-light">
  			<table class="table">
  				<tr>
  					...
  					<th>cuttack stock</th>
  					<th>brahampur</th>
  					<th>brahampur stock</th>
  					<th>jharsuguda</th>
  					<th>jharsuguda stock</th>
  					<th>sundergarh</th>
  					<th>sundergarh stock</th>
				...
				<tr>
					...
					<td><img width="80px" height="80px" src="<?php echo htmlspecialchars($product['item_image']) ?>" alt=""></td>  
  					...
  					<td><?php echo htmlspecialchars($product['bbsr_stock']) ?></td>
  					<td><?php echo htmlspecialchars($product['cuttack']) ?></td>
  					<td><?php echo htmlspecialchars($product['cuttack_stock']) ?></td>
  					<td><?php echo htmlspecialchars($product['brahmapur']) ?></td>
  					<td><?php echo htmlspecialchars($product['brahmapur_stock']) ?></td>
  					<td><?php echo htmlspecialchars($product['jharsuguda']) ?></td>
  					<td><?php echo htmlspecialchars($product['jharsuguda_stock']) ?></td>
					<td><?php echo htmlspecialchars($product['sundergarh']) ?></td>
					<td><?php echo htmlspecialchars($product['sundergarh_stock']) ?></td>
					<td>
