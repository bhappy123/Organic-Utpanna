	...
	<div class="modal-body">
		<form action="" method="post" enctype="multipart/form-data">
			...
			<div class="d-flex">
				...
				<div class="form-group pr-2">
					<label for="bbsr_stock">Bhubaneswar Stock</label>
					<input required value="<?php echo $result_item_details[0]['bbsr_stock'] ?>" type="text" class="form-control" name="bbsr_stock" id="bbsr_stock" placeholder="Edit Stock">
				</div>
				<div class="form-group pr-2">
				...
				<div class="form-group pr-2">
					<label for="cuttack_stock">Cuttack Stock</label>
					<input required value="<?php echo $result_item_details[0]['cuttack_stock'] ?>" type="text" class="form-control" name="cuttack_stock" id="cuttack_stock" placeholder="Edit Stock">
				</div>
				<div class="form-group pr-2">
			...
			<div class="form-group pr-2">
					<label for="jharsuguda_stock">Jharsuguda Stock</label>
					<input required value="<?php echo $result_item_details[0]['jharsuguda_stock'] ?>" type="text" class="form-control" name="jharsuguda_stock" id="jharsuguda_stock" placeholder="Edit Stock">
				</div>
			<div class="d-flex">
				<div class="form-group pr-2">
				...
				<div class="form-group pr-2">
					<label for="brahmapur_stock">Brahmapur Stock</label>
					<input required value="<?php echo $result_item_details[0]['brahmapur_stock'] ?>" type="text" class="form-control" name="brahmapur_stock" id="brahmapur_stock" placeholder="Edit Stock">
				</div>
				<div class="form-group pr-2">
				...
				<div class="form-group pr-2">
					<label for="sundergarh_stock">Sundergarh Stock</label>
					<input required value="<?php echo $result_item_details[0]['sundergarh_stock'] ?>" type="text" class="form-control" name="sundergarh_stock" id="sundergarh_stock" placeholder="Edit Stock">
				</div>
			</div>
