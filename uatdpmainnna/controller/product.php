...
if(isset($_SESSION['admin'])){
    ...
    if(isset($_POST['edit_product_btn'])){
        ...
        $category = $_POST['category'];
        $bbsr = $_POST['bbsr'];
        $bbsr_stock = $_POST['bbsr_stock'];
        $cuttack = $_POST['cuttack'];
        $cuttack_stock = $_POST['cuttack_stock'];
        $brahmapur = $_POST['brahmapur'];
        $brahmapur_stock = $_POST['brahmapur_stock'];
        $jharsuguda = $_POST['jharsuguda'];
        $jharsuguda_stock = $_POST['jharsuguda_stock'];
        $sundergarh = $_POST['sundergarh'];
        $sundergarh_stock = $_POST['sundergarh_stock'];
        $sql_edit_product = "UPDATE `product` SET `item_name`='$item_name',`size`='$size',`price`='$price',`category`='$category',`bbsr`='$bbsr',`cuttack`='$cuttack',`brahmapur`='$brahmapur',`jharsuguda`='$jharsuguda',`sundergarh`='$sundergarh',`bbsr_stock`='$bbsr_stock',`cuttack_stock`='$cuttack_stock',`brahmapur_stock`='$brahmapur_stock',`jharsuguda_stock`='$jharsuguda_stock',`sundergarh_stock`='$sundergarh_stock' WHERE `id`='$id'";
